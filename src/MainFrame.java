...
// По умолчанию пункт меню является недоступным (данных ещѐ нет)
        ...
        // Создать новое "действие" по открытию справки
        Action helpAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, " Студент 2 курса 9 группы Тихончук Владислав",
                        "О программе", JOptionPane.INFORMATION_MESSAGE );
            }
        };
// Добавить соответствующий пункт подменю в меню "Файл"
        descriptionMenuItem = helpMenu.add(helpAction);
